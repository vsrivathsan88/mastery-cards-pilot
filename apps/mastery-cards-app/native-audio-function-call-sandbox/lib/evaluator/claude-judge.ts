...
` : '';
  ...
  return `You are an educator evaluating a student's understanding of a concept. Analyze if the student has demonstrated understanding. It's important that you be strict and objective in your evaluation.
